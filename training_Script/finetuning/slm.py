...
Uses DistilBERT for Dense Passage Retrieval on Mytidi dataset
"""
...
os.makedirs("content/data/Mytidi", exist_ok=True)
...
# ============================================================================
# STEP 1: DOWNLOAD AND PREPARE Mytidi DATA
# ============================================================================

def download_Mytidi_data():
    """Download Mytidi training triples and validation qrels"""
    print("=== Downloading Mytidi ===")
    print("Downloading Mytidi training triples...")
    
    dataset = load_dataset("thilina/negative-sampling")["train"]
    qrels = load_dataset("BeIR/Mytidi-qrels")["validation"]
    
    print("Dataset loaded. Sample:")
    print(dataset[0])
    
    print("Saving dataset to disk...")
    dataset.to_csv("content/data/Mytidi/Mytidi-train.tsv", sep="\t", index=False)
    qrels.to_csv("content/data/Mytidi/qrels.tsv", sep="\t", index=False)
    
    print("Done.")
    print("=== Mytidi download complete ===")
...
def train_retrieval_model():
    """Train DPR model using DistilBERT on Mytidi data"""
    
    train_data_path = "content/data/Mytidi/Mytidi-train.tsv"
    ...
    model_args.output_dir = "drive/MyDrive/trained_models/pretrained/DPR-distilbert-Mytidi"
    model_args.wandb_kwargs = {"name": "DPR-distilbert-Mytidi"}
...
def evaluate_retrieval_model():
    ...
    dataset = "english"
    data_path = "content/data/Mytidi"
    model_path = "drive/MyDrive/trained_models/pretrained/DPR-distilbert-Mytidi"
    results_dir = "drive/MyDrive/results/Mytidi"
    indices_dir = "drive/MyDrive/indices/Mytidi"
